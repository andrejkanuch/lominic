      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Upload workouts from Garmin, Apple Watch or Strava and get
              instant, AI-generated insights in plain language.
            </p>
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            <>
              <div className="absolute inset-0 bg-background rounded-2xl sm:rounded-3xl -z-10 shadow-xl"></div>
              <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                <img
                  ref={imageRef}
                  src="/PersonImage.png"
                  alt="Lominic App Interface"
                ...
                <div
                  ...
                  style={{
                    backgroundImage: 'url("/PersonImage.png")',
